...
pub fn exec_simple_query_return(ctx: RetProbeContext) -> u32 {
    let thread_id = ctx.tgid();
...
pub fn exec_parse_message_return(ctx: RetProbeContext) -> u32 {
    let thread_id = ctx.tgid();
...
pub fn exec_bind_message_return(ctx: RetProbeContext) -> u32 {
    let thread_id = ctx.tgid();
...
pub fn exec_execute_message_return(ctx: RetProbeContext) -> u32 {
    let thread_id = ctx.tgid();
...
/// This function is used by the special hooks for the top level functions in
/// Postgres, as well as the autogenerated hooks for the lower level functions.
pub fn submit_return(ctx: RetProbeContext, func: &str, thread_id: ThreadId) -> u32 {
